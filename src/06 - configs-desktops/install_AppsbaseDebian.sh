...
sudo apt install vlc remmina audacious -y 
# Ferramentas e configurações para Linux
sudo apt install vim net-tools wine neofetch git plocate flatpak htop -y
#Linguagens de programação
sudo apt install lua5.4 openjdk-19-jdk gcc g++ -y
